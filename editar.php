...
if(isset($_POST) && count($_POST) > 0){
    ...
    WHERE a.id_associado = '$id_associado' AND a.status= 1";
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="p-5" align>
                        ...
                        <form class="user" method="POST" action="atualizar.php">
                        ...
                        <p></p>
                        <a  class="btn btn-primary btn-user btn-block" href="listar.php">Voltar </a>
