...
//var_dump($id_associado); die;
    ...
    $consulta_anuidades_em_aberto = "SELECT * FROM anuidade where status_anuidade = 0";
    
    $result = $conn->query($consulta_anuidades_em_aberto) or die($conn->error);
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="p-5" align>
                        ...
                        <h1 class="h4 text-gray-900 mb-4">Edição de Anuiade</h1>
                        </div>
                        <form class="user" method="POST" action="atualizar_anuidade.php">
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" id="ano" name="ano"
                                value = "<?php echo is_null($dado['ano']) ? " " :  $dado['ano']; ?>">
                            </div>
                            <div class="col-sm-6">
                                <input type="int" class="form-control form-control-user" name="valor" id="valor"
                                value = "<?php echo $dado['valor']; ?>">
                            </div>
                        </div>
                        <div>
                                <label>Status da Parcela</label>
                                <label><input value="1" type="radio" name="status_anuidade">Pago</label>
                                <label><input value="0" type="radio" name="status_anuidade" checked="true">Não pago</label>
                        </div>
                        ...
                        <p></p>
                        <a  class="btn btn-primary btn-user btn-block" href="parcelas_em_aberto.php">Voltar </a>
